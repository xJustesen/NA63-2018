...
int main(int argc, char const *argv[]) {
        ...
        cout << "Cut in x: {" << cut_lb_x << ", " << cut_ub_x << "} rad\n";
        cout << "Cut in y: {" << cut_lb_y << ", " << cut_ub_y << "} rad\n\n";
        ...
        //
        //         cout << "Plane " << i << ": Hits before removal: " << nhits0 <<  ";\thits after removal: " << nhits1 << ";\thits removed: " << nhits0 - nhits1 << ";\tPixels removed: " << hotpixel.size() << ";\tmax hits allowed per pixel: " << floor(4e-4 * Data->Nevents) << endl;
        //
        // }
        //
        ...
        // Data->T.load("/home/christian/Documents/cern2018/alignment_matrix.txt", arma_ascii); // 2018
