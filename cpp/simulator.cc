...
void simulator::generate_beam(void){
  ...
  string xdata_coords = "xdat_" + beam_spatial_distro,
         ydata_coords = "ydat_" + beam_spatial_distro,
         xdata_weights = "xweight_" + beam_spatial_distro,
         ydata_weights = "yweight_" + beam_spatial_distro,
         xangles_weights = "angles_xweight_" + beam_spatial_distro,
         yangles_weights = "angles_yweight_" + beam_spatial_distro,
         angles = "angles.txt";
